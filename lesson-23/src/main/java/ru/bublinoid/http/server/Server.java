...
import ru.bublinoid.http.server.web.CalculatorWebApplication;
import ru.bublinoid.http.server.web.GreetingsWebApplication;
import ru.bublinoid.http.server.web.ItemsWebApplication;
import ru.bublinoid.http.server.web.MyWebApplication;
